...
const argv = yargs
  ...
  .option('disableParallelReporter', {
    alias: 'f',
    type: 'boolean',
    default: false,
    description: 'Disable parallel reporter'
  })
  ...
  .option('splitByText', {
    alias: 'S',
    type: 'string[]',
    description: 'Split by text included in test file'
  }).argv;
...
const settings = {
  ...
  disableParallelReporter: argv.disableParallelReporter,
  script: argv.script,
  strictMode: argv.strictMode,
  splitByText: argv.splitByText ? argv.splitByText.split(',') : [],
